...
\begin{figure}[htbp]
% OLD \centerline{\includegraphics[width=6in]{Fig_Instr_Exec_w_FIFOs}}
...
be more complicated.  Even in RISC-V, when implementing the {\bf C}
...
\begin{figure}[htbp]
  \centerline{\includegraphics[width=\textwidth]{RSN_2025-09-15.000.00_Fife_Epochs}}
...
\begin{figure}[htbp]
% OLD: \centerline{\includegraphics[width=\textwidth]{Fig_RISCV_Scoreboard}}
  \centerline{\includegraphics[width=\textwidth]{RSN_2025-10-07.000.00_Scoreboard}}
...
\begin{figure}[htbp]
% OLD: \centerline{\includegraphics[width=\textwidth]{Figures/Fig_RISCV_Retire_Ordering}}
...
\index[RV]{Out-of-order execution}
\index[RV]{Reorder buffers}
...
\begin{figure}[htbp]
  \centerline{\includegraphics[width=\textwidth]{RSN_2025-10-07.002.00_Store_Buffer}}
...
\begin{figure}[htbp]
% OLD  \centerline{\includegraphics[width=6in,angle=0]{Fig_Retire_Layers_1_2}}
  \centerline{\includegraphics[width=6in,angle=0]{RSN_2025-10-13.001.00_Fife_Retire_L1_L2}}

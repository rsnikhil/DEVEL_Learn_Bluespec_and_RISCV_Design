...
\begin{figure}[htbp]
% OLD \centerline{\includegraphics[width=\textwidth]{Fig_Goals}}
  \centerline{\includegraphics[width=\textwidth]{RSN_2025-09-01.002.00_Fig_Goals}}
...
\emph{In this book we do not discuss how to install and use compilation tools}.
...
The two methods are cycle-by-cycle accurate with each other.  Further,
...
\begin{figure}[htbp]
% OLD  \centerline{\includegraphics[width=\textwidth]{Fig_Chapter_Roadmap}}
  \centerline{\includegraphics[width=\textwidth]{RSN_2025-10-13.000.00_Learn_Chapter_Roadmap}}
...
\begin{figure}[htbp]
% OLD \centerline{\includegraphics[width=\textwidth]{Fig_Two_Microarchitectures}}
  \centerline{\includegraphics[width=\textwidth]{RSN_2025-09-01.001.00_Two_MicroArchs}}
...
We strongly recommend, as you read the book, that you also keep
open a text editor in which you can simultaneously view the actual
sources.
...
\begin{figure}[htbp]
  ...
  \caption{\label{Fig_BSV_Digital_Circuits} Digital circuits consist
           of state elements interconnected with acyclic combinational
           circuits.}

\end{figure}

Connecting the output of a combinational circuit to the input of
another combinational circuit just builds a larger combinational
circuit ({\eg} the edge from the first to the second combinational

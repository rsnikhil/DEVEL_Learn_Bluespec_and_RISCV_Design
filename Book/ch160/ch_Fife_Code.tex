...
\begin{figure}[htbp]
% OLD \centerline{\includegraphics[width=6in,angle=0]{Figures/Fig_Instr_Exec_w_FIFOs}}
  \centerline{\includegraphics[width=6in]{RSN_2025-09-01.000.00_FifeDrum_Stages_Multilayer_L1_L2_L3}}
...
\SHOWCODE{Code_Extracts/Fife_mkCPU.tex}
...
here for reference):
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in]{Fig_Composed_FIFO_modularity}}
...
\SHOWCODE{Code_Extracts/Fife_mkFetch.tex}
...
\hm {\footnotesize \verb|(rg_running && (! f_F_from_Retire.notEmpty))|}
...
the Fetch stage of {\DRUM} (was described in Section~\ref{Sec_fn_Fetch}).
...
\index[BSV]{rule!prioritizing explicitly}
...
\SHOWCODE{Code_Extracts/Fife_mkDecode.tex}
...
\SHOWCODE{Code_Extracts/Fife_RR_WB_IFC.tex}
...
\index[BSV]{vector!library data type}
...
\index[BSV]{vector!library {\tt replicate} function}
...
\index[BSV]{vector!of {\tt n} bits \emph{vs.} {\tt Bit\#(n)}}
\index[BSV]{vector!representation in bits}
...
\SHOWCODE{Code_Extracts/Fife_mkRR_WB1.tex}
...
\SHOWCODE{Code_Extracts/Fife_mkRR_WB2.tex}
...
\EXERCISE{Ex-16-A-Register-Read-and-Dispatch}

% ----------------------------------------------------------------

\EXERCISE{Ex-16-B-Rule-Conditions}

% ----------------------------------------------------------------

\EXERCISE{Ex-16-C-Debugging-Stalled-Rules}
...
\SHOWCODE{Code_Extracts/Fife_mkRR_WB3.tex}
...
\SHOWCODE{Code_Extracts/Fife_mkRR_WB4.tex}
...
\SHOWCODE{Code_Extracts/Fife_EX_Control_IFC.tex}

The Execute Control stage module is shown below:

\SHOWCODE{Code_Extracts/Fife_mkEX_Control.tex}
...
\SHOWCODE{Code_Extracts/Fife_EX_Int_IFC.tex}

The Execute Integer stage module is shown below:

\SHOWCODE{Code_Extracts/Fife_mkEX_Int.tex}
...
\begin{figure}[htbp]
% OLD  \centerline{\includegraphics[width=6in,angle=0]{Figures/Fig_Retire_Layers_1_2}}
  \centerline{\includegraphics[width=6in,angle=0]{Figures/RSN_2025-10-13.001.00_Fife_Retire_L1_L2}}
...
\SHOWCODE{Code_Extracts/Fife_Retire_IFC.tex}
...
\SHOWCODE{Code_Extracts/Fife_Retire_Module_Mode.tex}

The first part of the Retire stage \verb|mkRetire| module is shown below.

\SHOWCODE{Code_Extracts/Fife_mkRetire1.tex}
...
\SHOWCODE{Code_Extracts/Fife_fa_redirect_Fetch.tex}
...
\SHOWCODE{Code_Extracts/Fife_fa_update_rd.tex}
...
\SHOWCODE{Code_Extracts/Fife_fa_retire_store_buf.tex}
...
\SHOWCODE{Code_Extracts/Fife_triage.tex}
...
\SHOWCODE{Code_Extracts/Fife_rl_wrong_path.tex}
...
\SHOWCODE{Code_Extracts/Fife_rl_CSRRxx.tex}
...
\EXERCISE{Ex-16-D-CSR-Method-Conflict}

% ----------------------------------------------------------------

\EXERCISE{Ex-16-E-Resolving-a-CSR-Method-Conflict}
...
\SHOWCODE{Code_Extracts/Fife_rl_MRET.tex}
...
\SHOWCODE{Code_Extracts/Fife_rl_ECALL.tex}
...
\SHOWCODE{Code_Extracts/Fife_rl_Dir_Exc.tex}
...
\SHOWCODE{Code_Extracts/Fife_S5_Control.tex}
...
\SHOWCODE{Code_Extracts/Fife_S5_Int.tex}
...
\SHOWCODE{Code_Extracts/Fife_S5_DMem.tex}
...
\EXERCISE{Ex-16-G-Rd-vs-Store-Buffer}
...
\SHOWCODE{Code_Extracts/Fife_S5_Deferred.tex}
...
\SHOWCODE{Code_Extracts/Fife_S5_Deferred_rsp.tex}
...
\EXERCISE{Ex-16-H-Retiring Deferred DMem}
...
\SHOWCODE{Code_Extracts/Fife_S5_exc.tex}
...
\SHOWCODE{Code_Extracts/Fife_mkRetire_ifc.tex}
